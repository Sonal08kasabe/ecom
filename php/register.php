...
<div class="container ">
    <div class="row justify-content-center mt-100" id="main">
        <div class="col-lg-12 " id="login-container" style="width:500px">
            <h3 class="text-center text-primary " style="margin-top:40%">Register to your ecom</h3>
            <div class="card" style="margin-top:20px">
                <div class="card-body">
                    <form action="insert.php" method="POST" >
                        ...
                        <a href="login.php" class="nav-link text-primary">Already have account ? Login</a>
                        <input type="submit" name="submit" id="submit" class="submit mt-2 btn btn-primary w-100">
                        </div>
